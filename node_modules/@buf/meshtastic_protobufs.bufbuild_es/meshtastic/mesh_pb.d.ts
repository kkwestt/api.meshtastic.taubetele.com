 ...
 */
export declare class MqttClientProxyMessage extends Message<MqttClientProxyMessage> {
  /**
   *
  ...
  constructor(data?: PartialMessage<MqttClientProxyMessage>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "meshtastic.MqttClientProxyMessage";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MqttClientProxyMessage;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MqttClientProxyMessage;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MqttClientProxyMessage;

  static equals(a: MqttClientProxyMessage | PlainMessage<MqttClientProxyMessage> | undefined, b: MqttClientProxyMessage | PlainMessage<MqttClientProxyMessage> | undefined): boolean;
}
 ...
 */
export declare class NeighborInfo extends Message<NeighborInfo> {
  /**
   *
  ...
  constructor(data?: PartialMessage<NeighborInfo>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "meshtastic.NeighborInfo";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): NeighborInfo;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): NeighborInfo;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): NeighborInfo;

  static equals(a: NeighborInfo | PlainMessage<NeighborInfo> | undefined, b: NeighborInfo | PlainMessage<NeighborInfo> | undefined): boolean;
}
 ...
 */
export declare class Neighbor extends Message<Neighbor> {
  /**
   *
   * Node ID of neighbor
   *
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "meshtastic.Neighbor";
  static readonly fields: FieldList;
