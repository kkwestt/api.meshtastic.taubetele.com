...
import type { NodeRemoteHardwarePin } from "./deviceonly_pb.js";
 ...
 */
export declare class NodeRemoteHardwarePinsResponse extends Message<NodeRemoteHardwarePinsResponse> {
  /**
   *
  ...
  constructor(data?: PartialMessage<NodeRemoteHardwarePinsResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "meshtastic.NodeRemoteHardwarePinsResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): NodeRemoteHardwarePinsResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): NodeRemoteHardwarePinsResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): NodeRemoteHardwarePinsResponse;

  static equals(a: NodeRemoteHardwarePinsResponse | PlainMessage<NodeRemoteHardwarePinsResponse> | undefined, b: NodeRemoteHardwarePinsResponse | PlainMessage<NodeRemoteHardwarePinsResponse> | undefined): boolean;
}
